// Modal crop ảnh đại diện (drag để chọn vùng, slider để zoom) — port nguyên văn từ
// frontend/public/js/avatar-cropper.js. Thuần DOM, không phụ thuộc framework nên giữ nguyên logic.
const CROP_SIZE = 512;
